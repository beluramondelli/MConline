...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
                        ...
                        <tr>
                            <td class="style8">
                               ...
                               <asp:Panel ID="Panel1" runat="server" 
                                    BackImageUrl="~/Imagenes/McDonaldAGUA.jpg" Height="785px" 
                                   ...
                                   <asp:ScriptManager ID="ScriptManager2" runat="server">
                                        ...
                                        <asp:Image ID="Image1" runat="server" Height="318px" ImageAlign="AbsMiddle" 
                                            Style="margin-left: 0px; margin-top: 155px" Width="243px" />
                    ...
                    margin-top: 156px" Width="232px" />
                                ...
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server" 
                                    BackImageUrl="~/Imagenes/mcdonalds-art-7AGUA.jpg" Height="473px">
                                </asp:UpdatePanel>
                                <br />
                            </td>
                        </tr>
